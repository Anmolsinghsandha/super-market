...
class Database{
		...
		private $db_host = "bllwr7mqwottsx3qc3xl-mysql.services.clever-cloud.com";  // Change as required
		private $db_user = "um9plrezhev6nmxn";       // Change as required
		private $db_pass = "jAyd4F1HHoE4dn5imD11";   // Change as required
		private $db_name = "bllwr7mqwottsx3qc3xl";   // Change as required
